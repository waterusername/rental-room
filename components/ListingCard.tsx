  ...
  return (
    <li>
      <Link
        ...
        className="flex h-full flex-col rounded-lg border border-line bg-panel p-4 text-ink no-underline shadow-[var(--shadow)] transition hover:border-accent-border hover:bg-accent-soft/40"
      >
